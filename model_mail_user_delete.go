...
// checks if the MailUserDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailUserDelete{}

// MailUserDelete struct for MailUserDelete
type MailUserDelete struct {
	Id string `json:"id"`
}
...
func (o MailUserDelete) MarshalJSON() ([]byte, error) {
...
func (o MailUserDelete) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableMailUserDelete struct {
	value *MailUserDelete
	isSet bool
}

func (v NullableMailUserDelete) Get() *MailUserDelete {
	return v.value
}

func (v *NullableMailUserDelete) Set(val *MailUserDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableMailUserDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableMailUserDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMailUserDelete(val *MailUserDelete) *NullableMailUserDelete {
	return &NullableMailUserDelete{value: val, isSet: true}
}

func (v NullableMailUserDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMailUserDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
