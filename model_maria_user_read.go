...
// checks if the MariaUserRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MariaUserRead{}

// MariaUserRead struct for MariaUserRead
type MariaUserRead struct {
	Id string `json:"id"`
}
...
func (o MariaUserRead) MarshalJSON() ([]byte, error) {
...
func (o MariaUserRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableMariaUserRead struct {
	value *MariaUserRead
	isSet bool
}

func (v NullableMariaUserRead) Get() *MariaUserRead {
	return v.value
}

func (v *NullableMariaUserRead) Set(val *MariaUserRead) {
	v.value = val
	v.isSet = true
}

func (v NullableMariaUserRead) IsSet() bool {
	return v.isSet
}

func (v *NullableMariaUserRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMariaUserRead(val *MariaUserRead) *NullableMariaUserRead {
	return &NullableMariaUserRead{value: val, isSet: true}
}

func (v NullableMariaUserRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMariaUserRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
