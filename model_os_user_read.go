...
// checks if the OSUserRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OSUserRead{}

// OSUserRead struct for OSUserRead
type OSUserRead struct {
	Id string `json:"id"`
}
...
func (o OSUserRead) MarshalJSON() ([]byte, error) {
...
func (o OSUserRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableOSUserRead struct {
	value *OSUserRead
	isSet bool
}

func (v NullableOSUserRead) Get() *OSUserRead {
	return v.value
}

func (v *NullableOSUserRead) Set(val *OSUserRead) {
	v.value = val
	v.isSet = true
}

func (v NullableOSUserRead) IsSet() bool {
	return v.isSet
}

func (v *NullableOSUserRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOSUserRead(val *OSUserRead) *NullableOSUserRead {
	return &NullableOSUserRead{value: val, isSet: true}
}

func (v NullableOSUserRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOSUserRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
