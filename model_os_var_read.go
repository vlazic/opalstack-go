...
// checks if the OSVarRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OSVarRead{}

// OSVarRead struct for OSVarRead
type OSVarRead struct {
	Id string `json:"id"`
}
...
func (o OSVarRead) MarshalJSON() ([]byte, error) {
...
func (o OSVarRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableOSVarRead struct {
	value *OSVarRead
	isSet bool
}

func (v NullableOSVarRead) Get() *OSVarRead {
	return v.value
}

func (v *NullableOSVarRead) Set(val *OSVarRead) {
	v.value = val
	v.isSet = true
}

func (v NullableOSVarRead) IsSet() bool {
	return v.isSet
}

func (v *NullableOSVarRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOSVarRead(val *OSVarRead) *NullableOSVarRead {
	return &NullableOSVarRead{value: val, isSet: true}
}

func (v NullableOSVarRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOSVarRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
