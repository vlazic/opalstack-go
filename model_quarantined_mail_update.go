...
// checks if the QuarantinedMailUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuarantinedMailUpdate{}

// QuarantinedMailUpdate struct for QuarantinedMailUpdate
type QuarantinedMailUpdate struct {
	Id string `json:"id"`
}
...
func (o QuarantinedMailUpdate) MarshalJSON() ([]byte, error) {
...
func (o QuarantinedMailUpdate) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableQuarantinedMailUpdate struct {
	value *QuarantinedMailUpdate
	isSet bool
}

func (v NullableQuarantinedMailUpdate) Get() *QuarantinedMailUpdate {
	return v.value
}

func (v *NullableQuarantinedMailUpdate) Set(val *QuarantinedMailUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableQuarantinedMailUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableQuarantinedMailUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuarantinedMailUpdate(val *QuarantinedMailUpdate) *NullableQuarantinedMailUpdate {
	return &NullableQuarantinedMailUpdate{value: val, isSet: true}
}

func (v NullableQuarantinedMailUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuarantinedMailUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
