...
// DNSRecordTypeEnum the model 'DNSRecordTypeEnum'
type DNSRecordTypeEnum string

// List of DNSRecordTypeEnum
const (
	DNSRECORDTYPEENUM_A DNSRecordTypeEnum = "A"
	DNSRECORDTYPEENUM_AAAA DNSRecordTypeEnum = "AAAA"
	DNSRECORDTYPEENUM_CNAME DNSRecordTypeEnum = "CNAME"
	DNSRECORDTYPEENUM_MX DNSRecordTypeEnum = "MX"
	DNSRECORDTYPEENUM_TXT DNSRecordTypeEnum = "TXT"
	DNSRECORDTYPEENUM_SRV DNSRecordTypeEnum = "SRV"
	DNSRECORDTYPEENUM_CAA DNSRecordTypeEnum = "CAA"
)

// All allowed values of DNSRecordTypeEnum enum
var AllowedDNSRecordTypeEnumEnumValues = []DNSRecordTypeEnum{
	"A",
	"AAAA",
	"CNAME",
	"MX",
...
func (v *DNSRecordTypeEnum) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := DNSRecordTypeEnum(value)
	for _, existing := range AllowedDNSRecordTypeEnumEnumValues {
	...
	return fmt.Errorf("%+v is not a valid DNSRecordTypeEnum", value)
}

// NewDNSRecordTypeEnumFromValue returns a pointer to a valid DNSRecordTypeEnum
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewDNSRecordTypeEnumFromValue(v string) (*DNSRecordTypeEnum, error) {
	ev := DNSRecordTypeEnum(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for DNSRecordTypeEnum: valid values are %v", v, AllowedDNSRecordTypeEnumEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v DNSRecordTypeEnum) IsValid() bool {
	for _, existing := range AllowedDNSRecordTypeEnumEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to DNSRecordTypeEnum value
func (v DNSRecordTypeEnum) Ptr() *DNSRecordTypeEnum {
	return &v
}

type NullableDNSRecordTypeEnum struct {
	value *DNSRecordTypeEnum
	isSet bool
}

func (v NullableDNSRecordTypeEnum) Get() *DNSRecordTypeEnum {
	return v.value
}

func (v *NullableDNSRecordTypeEnum) Set(val *DNSRecordTypeEnum) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSRecordTypeEnum) IsSet() bool {
	return v.isSet
}

func (v *NullableDNSRecordTypeEnum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDNSRecordTypeEnum(val *DNSRecordTypeEnum) *NullableDNSRecordTypeEnum {
	return &NullableDNSRecordTypeEnum{value: val, isSet: true}
}

func (v NullableDNSRecordTypeEnum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDNSRecordTypeEnum) UnmarshalJSON(src []byte) error {
	v.isSet = true
