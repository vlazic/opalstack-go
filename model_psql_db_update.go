...
// checks if the PsqlDBUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PsqlDBUpdate{}

// PsqlDBUpdate struct for PsqlDBUpdate
type PsqlDBUpdate struct {
	Id string `json:"id"`
...
func (o PsqlDBUpdate) MarshalJSON() ([]byte, error) {
...
func (o PsqlDBUpdate) ToMap() (map[string]interface{}, error) {
...
type NullablePsqlDBUpdate struct {
	value *PsqlDBUpdate
	isSet bool
}

func (v NullablePsqlDBUpdate) Get() *PsqlDBUpdate {
	return v.value
}

func (v *NullablePsqlDBUpdate) Set(val *PsqlDBUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullablePsqlDBUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullablePsqlDBUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePsqlDBUpdate(val *PsqlDBUpdate) *NullablePsqlDBUpdate {
	return &NullablePsqlDBUpdate{value: val, isSet: true}
}

func (v NullablePsqlDBUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePsqlDBUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
