...
// checks if the OSUserUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OSUserUpdate{}

// OSUserUpdate struct for OSUserUpdate
type OSUserUpdate struct {
	Id string `json:"id"`
...
func (o OSUserUpdate) MarshalJSON() ([]byte, error) {
...
func (o OSUserUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableOSUserUpdate struct {
	value *OSUserUpdate
	isSet bool
}

func (v NullableOSUserUpdate) Get() *OSUserUpdate {
	return v.value
}

func (v *NullableOSUserUpdate) Set(val *OSUserUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableOSUserUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableOSUserUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOSUserUpdate(val *OSUserUpdate) *NullableOSUserUpdate {
	return &NullableOSUserUpdate{value: val, isSet: true}
}

func (v NullableOSUserUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOSUserUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
