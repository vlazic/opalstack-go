...
type ApiMailusageLatestRequest struct {
	ctx context.Context
	ApiService *UsageAPIService
}

func (r ApiMailusageLatestRequest) Execute() (*MailUsageResponse, *http.Response, error) {
	return r.ApiService.MailusageLatestExecute(r)
}

/*
MailusageLatest Method for MailusageLatest

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMailusageLatestRequest
*/
func (a *UsageAPIService) MailusageLatest(ctx context.Context) ApiMailusageLatestRequest {
	return ApiMailusageLatestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return MailUsageResponse
func (a *UsageAPIService) MailusageLatestExecute(r ApiMailusageLatestRequest) (*MailUsageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MailUsageResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsageAPIService.MailusageLatest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/usage/mail/latest/"
...
type ApiWebusageLatestRequest struct {
	ctx context.Context
	ApiService *UsageAPIService
}

func (r ApiWebusageLatestRequest) Execute() (*WebUsageResponse, *http.Response, error) {
	return r.ApiService.WebusageLatestExecute(r)
}

/*
WebusageLatest Method for WebusageLatest

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiWebusageLatestRequest
*/
func (a *UsageAPIService) WebusageLatest(ctx context.Context) ApiWebusageLatestRequest {
	return ApiWebusageLatestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UsageAPIService) WebusageLatestExecute(r ApiWebusageLatestRequest) (*WebUsageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WebUsageResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsageAPIService.WebusageLatest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/usage/web/latest/"
