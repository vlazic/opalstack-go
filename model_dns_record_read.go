...
// checks if the DNSRecordRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DNSRecordRead{}

// DNSRecordRead struct for DNSRecordRead
type DNSRecordRead struct {
	Id string `json:"id"`
}
...
func (o DNSRecordRead) MarshalJSON() ([]byte, error) {
...
func (o DNSRecordRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableDNSRecordRead struct {
	value *DNSRecordRead
	isSet bool
}

func (v NullableDNSRecordRead) Get() *DNSRecordRead {
	return v.value
}

func (v *NullableDNSRecordRead) Set(val *DNSRecordRead) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSRecordRead) IsSet() bool {
	return v.isSet
}

func (v *NullableDNSRecordRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDNSRecordRead(val *DNSRecordRead) *NullableDNSRecordRead {
	return &NullableDNSRecordRead{value: val, isSet: true}
}

func (v NullableDNSRecordRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDNSRecordRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
