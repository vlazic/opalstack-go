...
// checks if the WebUsageWebServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebUsageWebServer{}

// WebUsageWebServer struct for WebUsageWebServer
type WebUsageWebServer struct {
	Id string `json:"id"`
...
func (o WebUsageWebServer) MarshalJSON() ([]byte, error) {
...
func (o WebUsageWebServer) ToMap() (map[string]interface{}, error) {
...
type NullableWebUsageWebServer struct {
	value *WebUsageWebServer
	isSet bool
}

func (v NullableWebUsageWebServer) Get() *WebUsageWebServer {
	return v.value
}

func (v *NullableWebUsageWebServer) Set(val *WebUsageWebServer) {
	v.value = val
	v.isSet = true
}

func (v NullableWebUsageWebServer) IsSet() bool {
	return v.isSet
}

func (v *NullableWebUsageWebServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebUsageWebServer(val *WebUsageWebServer) *NullableWebUsageWebServer {
	return &NullableWebUsageWebServer{value: val, isSet: true}
}

func (v NullableWebUsageWebServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebUsageWebServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
