...
// checks if the MariaDBUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MariaDBUpdate{}

// MariaDBUpdate struct for MariaDBUpdate
...
func (o MariaDBUpdate) MarshalJSON() ([]byte, error) {
...
func (o MariaDBUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableMariaDBUpdate struct {
	value *MariaDBUpdate
	isSet bool
}

func (v NullableMariaDBUpdate) Get() *MariaDBUpdate {
	return v.value
}

func (v *NullableMariaDBUpdate) Set(val *MariaDBUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableMariaDBUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableMariaDBUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMariaDBUpdate(val *MariaDBUpdate) *NullableMariaDBUpdate {
	return &NullableMariaDBUpdate{value: val, isSet: true}
}

func (v NullableMariaDBUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMariaDBUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
