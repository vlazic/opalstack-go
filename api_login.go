...
func (r ApiLoginRequest) Signin(signin Signin) ApiLoginRequest {
	r.signin = &signin
	return r
}

func (r ApiLoginRequest) Execute() (*SigninResponse, *http.Response, error) {
...
func (a *LoginAPIService) LoginExecute(r ApiLoginRequest) (*SigninResponse, *http.Response, error) {
	var (
