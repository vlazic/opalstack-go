...
// checks if the PsqlDBRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PsqlDBRead{}

// PsqlDBRead struct for PsqlDBRead
type PsqlDBRead struct {
	Id string `json:"id"`
}
...
func (o PsqlDBRead) MarshalJSON() ([]byte, error) {
...
func (o PsqlDBRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullablePsqlDBRead struct {
	value *PsqlDBRead
	isSet bool
}

func (v NullablePsqlDBRead) Get() *PsqlDBRead {
	return v.value
}

func (v *NullablePsqlDBRead) Set(val *PsqlDBRead) {
	v.value = val
	v.isSet = true
}

func (v NullablePsqlDBRead) IsSet() bool {
	return v.isSet
}

func (v *NullablePsqlDBRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePsqlDBRead(val *PsqlDBRead) *NullablePsqlDBRead {
	return &NullablePsqlDBRead{value: val, isSet: true}
}

func (v NullablePsqlDBRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePsqlDBRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
