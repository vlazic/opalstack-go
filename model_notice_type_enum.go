...
// NoticeTypeEnum the model 'NoticeTypeEnum'
...
var AllowedNoticeTypeEnumEnumValues = []NoticeTypeEnum{
	"M",
	"P",
	"D",
	"R",
...
func (v *NoticeTypeEnum) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := NoticeTypeEnum(value)
	for _, existing := range AllowedNoticeTypeEnumEnumValues {
	...
	return fmt.Errorf("%+v is not a valid NoticeTypeEnum", value)
}

// NewNoticeTypeEnumFromValue returns a pointer to a valid NoticeTypeEnum
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewNoticeTypeEnumFromValue(v string) (*NoticeTypeEnum, error) {
	ev := NoticeTypeEnum(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for NoticeTypeEnum: valid values are %v", v, AllowedNoticeTypeEnumEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v NoticeTypeEnum) IsValid() bool {
	for _, existing := range AllowedNoticeTypeEnumEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to NoticeTypeEnum value
func (v NoticeTypeEnum) Ptr() *NoticeTypeEnum {
	return &v
}

type NullableNoticeTypeEnum struct {
	value *NoticeTypeEnum
	isSet bool
}

func (v NullableNoticeTypeEnum) Get() *NoticeTypeEnum {
	return v.value
}

func (v *NullableNoticeTypeEnum) Set(val *NoticeTypeEnum) {
	v.value = val
	v.isSet = true
}

func (v NullableNoticeTypeEnum) IsSet() bool {
	return v.isSet
}

func (v *NullableNoticeTypeEnum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNoticeTypeEnum(val *NoticeTypeEnum) *NullableNoticeTypeEnum {
	return &NullableNoticeTypeEnum{value: val, isSet: true}
}

func (v NullableNoticeTypeEnum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNoticeTypeEnum) UnmarshalJSON(src []byte) error {
	v.isSet = true
