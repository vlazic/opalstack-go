...
// checks if the WebServerReadResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebServerReadResponse{}

// WebServerReadResponse struct for WebServerReadResponse
type WebServerReadResponse struct {
	Id string `json:"id"`
...
func (o WebServerReadResponse) MarshalJSON() ([]byte, error) {
...
func (o WebServerReadResponse) ToMap() (map[string]interface{}, error) {
...
type NullableWebServerReadResponse struct {
	value *WebServerReadResponse
	isSet bool
}

func (v NullableWebServerReadResponse) Get() *WebServerReadResponse {
	return v.value
}

func (v *NullableWebServerReadResponse) Set(val *WebServerReadResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebServerReadResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebServerReadResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebServerReadResponse(val *WebServerReadResponse) *NullableWebServerReadResponse {
	return &NullableWebServerReadResponse{value: val, isSet: true}
}

func (v NullableWebServerReadResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebServerReadResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
