...
// checks if the CertRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertRead{}

// CertRead struct for CertRead
type CertRead struct {
	Id string `json:"id"`
}
...
func (o CertRead) MarshalJSON() ([]byte, error) {
...
func (o CertRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableCertRead struct {
	value *CertRead
	isSet bool
}

func (v NullableCertRead) Get() *CertRead {
	return v.value
}

func (v *NullableCertRead) Set(val *CertRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCertRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCertRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertRead(val *CertRead) *NullableCertRead {
	return &NullableCertRead{value: val, isSet: true}
}

func (v NullableCertRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
