...
// checks if the WebUsagePsqlDB type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebUsagePsqlDB{}

// WebUsagePsqlDB struct for WebUsagePsqlDB
type WebUsagePsqlDB struct {
	Id string `json:"id"`
...
func (o WebUsagePsqlDB) MarshalJSON() ([]byte, error) {
...
func (o WebUsagePsqlDB) ToMap() (map[string]interface{}, error) {
...
type NullableWebUsagePsqlDB struct {
	value *WebUsagePsqlDB
	isSet bool
}

func (v NullableWebUsagePsqlDB) Get() *WebUsagePsqlDB {
	return v.value
}

func (v *NullableWebUsagePsqlDB) Set(val *WebUsagePsqlDB) {
	v.value = val
	v.isSet = true
}

func (v NullableWebUsagePsqlDB) IsSet() bool {
	return v.isSet
}

func (v *NullableWebUsagePsqlDB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebUsagePsqlDB(val *WebUsagePsqlDB) *NullableWebUsagePsqlDB {
	return &NullableWebUsagePsqlDB{value: val, isSet: true}
}

func (v NullableWebUsagePsqlDB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebUsagePsqlDB) UnmarshalJSON(src []byte) error {
	v.isSet = true
