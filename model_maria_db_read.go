...
// checks if the MariaDBRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MariaDBRead{}

// MariaDBRead struct for MariaDBRead
type MariaDBRead struct {
	Id string `json:"id"`
}
...
func (o MariaDBRead) MarshalJSON() ([]byte, error) {
...
func (o MariaDBRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableMariaDBRead struct {
	value *MariaDBRead
	isSet bool
}

func (v NullableMariaDBRead) Get() *MariaDBRead {
	return v.value
}

func (v *NullableMariaDBRead) Set(val *MariaDBRead) {
	v.value = val
	v.isSet = true
}

func (v NullableMariaDBRead) IsSet() bool {
	return v.isSet
}

func (v *NullableMariaDBRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMariaDBRead(val *MariaDBRead) *NullableMariaDBRead {
	return &NullableMariaDBRead{value: val, isSet: true}
}

func (v NullableMariaDBRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMariaDBRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
