...
// checks if the PsqlDBResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PsqlDBResponse{}

// PsqlDBResponse struct for PsqlDBResponse
...
func (o PsqlDBResponse) MarshalJSON() ([]byte, error) {
...
func (o PsqlDBResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePsqlDBResponse struct {
	value *PsqlDBResponse
	isSet bool
}

func (v NullablePsqlDBResponse) Get() *PsqlDBResponse {
	return v.value
}

func (v *NullablePsqlDBResponse) Set(val *PsqlDBResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePsqlDBResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePsqlDBResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePsqlDBResponse(val *PsqlDBResponse) *NullablePsqlDBResponse {
	return &NullablePsqlDBResponse{value: val, isSet: true}
}

func (v NullablePsqlDBResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePsqlDBResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
