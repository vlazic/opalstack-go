...
// checks if the MariaUserResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MariaUserResponse{}

// MariaUserResponse struct for MariaUserResponse
...
func (o MariaUserResponse) MarshalJSON() ([]byte, error) {
...
func (o MariaUserResponse) ToMap() (map[string]interface{}, error) {
...
type NullableMariaUserResponse struct {
	value *MariaUserResponse
	isSet bool
}

func (v NullableMariaUserResponse) Get() *MariaUserResponse {
	return v.value
}

func (v *NullableMariaUserResponse) Set(val *MariaUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMariaUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMariaUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMariaUserResponse(val *MariaUserResponse) *NullableMariaUserResponse {
	return &NullableMariaUserResponse{value: val, isSet: true}
}

func (v NullableMariaUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMariaUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
