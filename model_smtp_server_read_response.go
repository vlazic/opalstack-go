...
// checks if the SmtpServerReadResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmtpServerReadResponse{}

// SmtpServerReadResponse struct for SmtpServerReadResponse
type SmtpServerReadResponse struct {
	Id string `json:"id"`
...
func NewSmtpServerReadResponse(id string) *SmtpServerReadResponse {
	this := SmtpServerReadResponse{}
	this.Id = id
	var hostname string = "smtp1.us.opalstack.com"
	this.Hostname = &hostname
	var type_ string = "smtp"
	this.Type = &type_
	return &this
}
...
func (o SmtpServerReadResponse) MarshalJSON() ([]byte, error) {
...
func (o SmtpServerReadResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSmtpServerReadResponse struct {
	value *SmtpServerReadResponse
	isSet bool
}

func (v NullableSmtpServerReadResponse) Get() *SmtpServerReadResponse {
	return v.value
}

func (v *NullableSmtpServerReadResponse) Set(val *SmtpServerReadResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSmtpServerReadResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSmtpServerReadResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmtpServerReadResponse(val *SmtpServerReadResponse) *NullableSmtpServerReadResponse {
	return &NullableSmtpServerReadResponse{value: val, isSet: true}
}

func (v NullableSmtpServerReadResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmtpServerReadResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
