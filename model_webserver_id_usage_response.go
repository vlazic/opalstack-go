...
// checks if the WebserverIdUsageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebserverIdUsageResponse{}

// WebserverIdUsageResponse struct for WebserverIdUsageResponse
type WebserverIdUsageResponse struct {
	UUID WebserverUsageResponse `json:"UUID"`
}
...
func (o *WebserverIdUsageResponse) GetUUID() WebserverUsageResponse {
	if o == nil {
		var ret WebserverUsageResponse
		return ret
	}
...
func (o WebserverIdUsageResponse) MarshalJSON() ([]byte, error) {
...
func (o WebserverIdUsageResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["UUID"] = o.UUID
	return toSerialize, nil
}

type NullableWebserverIdUsageResponse struct {
	value *WebserverIdUsageResponse
	isSet bool
}

func (v NullableWebserverIdUsageResponse) Get() *WebserverIdUsageResponse {
	return v.value
}

func (v *NullableWebserverIdUsageResponse) Set(val *WebserverIdUsageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebserverIdUsageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebserverIdUsageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebserverIdUsageResponse(val *WebserverIdUsageResponse) *NullableWebserverIdUsageResponse {
	return &NullableWebserverIdUsageResponse{value: val, isSet: true}
}

func (v NullableWebserverIdUsageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebserverIdUsageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
