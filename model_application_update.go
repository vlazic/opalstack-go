...
// checks if the ApplicationUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationUpdate{}

// ApplicationUpdate struct for ApplicationUpdate
...
// SetType gets a reference to the given AppTypeEnum and assigns it to the Type field.
...
func (o ApplicationUpdate) MarshalJSON() ([]byte, error) {
...
func (o ApplicationUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableApplicationUpdate struct {
	value *ApplicationUpdate
	isSet bool
}

func (v NullableApplicationUpdate) Get() *ApplicationUpdate {
	return v.value
}

func (v *NullableApplicationUpdate) Set(val *ApplicationUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationUpdate(val *ApplicationUpdate) *NullableApplicationUpdate {
	return &NullableApplicationUpdate{value: val, isSet: true}
}

func (v NullableApplicationUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
