...
// checks if the ApplicationInstalledRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationInstalledRequest{}

// ApplicationInstalledRequest struct for ApplicationInstalledRequest
type ApplicationInstalledRequest struct {
	Id string `json:"id"`
}
...
func NewApplicationInstalledRequest(id string) *ApplicationInstalledRequest {
	this := ApplicationInstalledRequest{}
	this.Id = id
	return &this
}
...
func (o ApplicationInstalledRequest) MarshalJSON() ([]byte, error) {
...
func (o ApplicationInstalledRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableApplicationInstalledRequest struct {
	value *ApplicationInstalledRequest
	isSet bool
}

func (v NullableApplicationInstalledRequest) Get() *ApplicationInstalledRequest {
	return v.value
}

func (v *NullableApplicationInstalledRequest) Set(val *ApplicationInstalledRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationInstalledRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationInstalledRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationInstalledRequest(val *ApplicationInstalledRequest) *NullableApplicationInstalledRequest {
	return &NullableApplicationInstalledRequest{value: val, isSet: true}
}

func (v NullableApplicationInstalledRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationInstalledRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
