...
// checks if the NoticeUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NoticeUpdate{}

// NoticeUpdate struct for NoticeUpdate
...
func (o NoticeUpdate) MarshalJSON() ([]byte, error) {
...
func (o NoticeUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableNoticeUpdate struct {
	value *NoticeUpdate
	isSet bool
}

func (v NullableNoticeUpdate) Get() *NoticeUpdate {
	return v.value
}

func (v *NullableNoticeUpdate) Set(val *NoticeUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableNoticeUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableNoticeUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNoticeUpdate(val *NoticeUpdate) *NullableNoticeUpdate {
	return &NullableNoticeUpdate{value: val, isSet: true}
}

func (v NullableNoticeUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNoticeUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
