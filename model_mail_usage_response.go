...
// checks if the MailUsageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailUsageResponse{}

// MailUsageResponse struct for MailUsageResponse
type MailUsageResponse struct {
	Mailusers []MailUsageMailUserResponse `json:"mailusers"`
}
...
// GetMailusers returns the Mailusers field value
func (o *MailUsageResponse) GetMailusers() []MailUsageMailUserResponse {
	if o == nil {
		var ret []MailUsageMailUserResponse
		return ret
	}
...
// GetMailusersOk returns a tuple with the Mailusers field value
// and a boolean to check if the value has been set.
func (o *MailUsageResponse) GetMailusersOk() ([]MailUsageMailUserResponse, bool) {
	if o == nil {
		return nil, false
	}
	return o.Mailusers, true
}

// SetMailusers sets field value
func (o *MailUsageResponse) SetMailusers(v []MailUsageMailUserResponse) {
	o.Mailusers = v
}

func (o MailUsageResponse) MarshalJSON() ([]byte, error) {
...
func (o MailUsageResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["mailusers"] = o.Mailusers
	return toSerialize, nil
}

type NullableMailUsageResponse struct {
	value *MailUsageResponse
	isSet bool
}

func (v NullableMailUsageResponse) Get() *MailUsageResponse {
	return v.value
}

func (v *NullableMailUsageResponse) Set(val *MailUsageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMailUsageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMailUsageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMailUsageResponse(val *MailUsageResponse) *NullableMailUsageResponse {
	return &NullableMailUsageResponse{value: val, isSet: true}
}

func (v NullableMailUsageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMailUsageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
