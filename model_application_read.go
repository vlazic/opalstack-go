...
// checks if the ApplicationRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationRead{}

// ApplicationRead struct for ApplicationRead
...
func (o ApplicationRead) MarshalJSON() ([]byte, error) {
...
func (o ApplicationRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableApplicationRead struct {
	value *ApplicationRead
	isSet bool
}

func (v NullableApplicationRead) Get() *ApplicationRead {
	return v.value
}

func (v *NullableApplicationRead) Set(val *ApplicationRead) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationRead) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationRead(val *ApplicationRead) *NullableApplicationRead {
	return &NullableApplicationRead{value: val, isSet: true}
}

func (v NullableApplicationRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
