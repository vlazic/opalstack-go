...
// checks if the LEChallengeCheckResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LEChallengeCheckResponse{}

// LEChallengeCheckResponse struct for LEChallengeCheckResponse
type LEChallengeCheckResponse struct {
...
// SetChallenges gets a reference to the given []bool and assigns it to the Challenges field.
func (o *LEChallengeCheckResponse) SetChallenges(v []bool) {
	o.Challenges = v
}

func (o LEChallengeCheckResponse) MarshalJSON() ([]byte, error) {
...
func (o LEChallengeCheckResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLEChallengeCheckResponse struct {
	value *LEChallengeCheckResponse
	isSet bool
}

func (v NullableLEChallengeCheckResponse) Get() *LEChallengeCheckResponse {
	return v.value
}

func (v *NullableLEChallengeCheckResponse) Set(val *LEChallengeCheckResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLEChallengeCheckResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLEChallengeCheckResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLEChallengeCheckResponse(val *LEChallengeCheckResponse) *NullableLEChallengeCheckResponse {
	return &NullableLEChallengeCheckResponse{value: val, isSet: true}
}

func (v NullableLEChallengeCheckResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLEChallengeCheckResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
