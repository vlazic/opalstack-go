...
// checks if the VirtualAliasResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualAliasResponse{}

// VirtualAliasResponse struct for VirtualAliasResponse
type VirtualAliasResponse struct {
	Id string `json:"id"`
...
func (o VirtualAliasResponse) MarshalJSON() ([]byte, error) {
...
func (o VirtualAliasResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVirtualAliasResponse struct {
	value *VirtualAliasResponse
	isSet bool
}

func (v NullableVirtualAliasResponse) Get() *VirtualAliasResponse {
	return v.value
}

func (v *NullableVirtualAliasResponse) Set(val *VirtualAliasResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualAliasResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualAliasResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualAliasResponse(val *VirtualAliasResponse) *NullableVirtualAliasResponse {
	return &NullableVirtualAliasResponse{value: val, isSet: true}
}

func (v NullableVirtualAliasResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualAliasResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
