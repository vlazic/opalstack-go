...
// checks if the NoticeRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NoticeRead{}

// NoticeRead struct for NoticeRead
...
func (o NoticeRead) MarshalJSON() ([]byte, error) {
...
func (o NoticeRead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

type NullableNoticeRead struct {
	value *NoticeRead
	isSet bool
}

func (v NullableNoticeRead) Get() *NoticeRead {
	return v.value
}

func (v *NullableNoticeRead) Set(val *NoticeRead) {
	v.value = val
	v.isSet = true
}

func (v NullableNoticeRead) IsSet() bool {
	return v.isSet
}

func (v *NullableNoticeRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNoticeRead(val *NoticeRead) *NullableNoticeRead {
	return &NullableNoticeRead{value: val, isSet: true}
}

func (v NullableNoticeRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNoticeRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
