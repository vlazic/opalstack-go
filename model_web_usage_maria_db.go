...
// checks if the WebUsageMariaDB type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebUsageMariaDB{}

// WebUsageMariaDB struct for WebUsageMariaDB
type WebUsageMariaDB struct {
	Id string `json:"id"`
...
func (o WebUsageMariaDB) MarshalJSON() ([]byte, error) {
...
func (o WebUsageMariaDB) ToMap() (map[string]interface{}, error) {
...
type NullableWebUsageMariaDB struct {
	value *WebUsageMariaDB
	isSet bool
}

func (v NullableWebUsageMariaDB) Get() *WebUsageMariaDB {
	return v.value
}

func (v *NullableWebUsageMariaDB) Set(val *WebUsageMariaDB) {
	v.value = val
	v.isSet = true
}

func (v NullableWebUsageMariaDB) IsSet() bool {
	return v.isSet
}

func (v *NullableWebUsageMariaDB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebUsageMariaDB(val *WebUsageMariaDB) *NullableWebUsageMariaDB {
	return &NullableWebUsageMariaDB{value: val, isSet: true}
}

func (v NullableWebUsageMariaDB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebUsageMariaDB) UnmarshalJSON(src []byte) error {
	v.isSet = true
